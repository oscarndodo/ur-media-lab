...
@section('main')
    ...
    <main class="p-6">
        <form class="form-container" action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST"
            ...
            <div class="form-header flex items-center">
                ...
                <h1>
                    ...
                    Editar de Docente {{ $teacher->name }}
                </h1>
            </div>
            ...
            <div id="teacherForm" class="form-body">
                ...
                <div class="form-section">
                    ...
                    overflow-hidden shadow-sm transition-all duration-200 hover:ring-2 hover:ring-blue-400 cursor-pointer">
                                @if ($teacher->bio->photo)
                                    <img src="{{ asset($teacher->bio->photo) }}" alt="" srcset="">
                                @else
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" value="{{ $teacher->name }}"
                                class="form-input" placeholder="Ex: Carlos Silva" required>
                            <div class="error-message" id="nameError"></div>
                        </div>

                        <div class="form-group">
                            <label for="email" class="form-label required">Email</label>
                            <input type="email" id="email" name="email" value="{{ $teacher->email }}" disabled
                                aria-disabled="true" class="form-input cursor-not-allowed bg-gray-400"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="bio" name="description" class="form-input textarea"
                            placeholder="Descreva a formação e experiência do docente..." maxlength="500">{!! $teacher->bio->description !!}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <select id="formation" name="formation" class="form-input" required>
                                    <option value="Licenciatura" @if ($teacher->bio->formation == 'Licenciatura') selected @endif>
                                        Licenciatura</option>
                                    <option value="Mestrado" @if ($teacher->bio->formation == 'Mestrado') selected @endif>Mestrado
                                    </option>
                                    <option value="Doutorado" @if ($teacher->bio->formation == 'Doutorado') selected @endif>Doutorado
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="course" name="area" value="{{ $teacher->bio->area }}"
                                class="form-input" placeholder="Ex: Letras - Inglês" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="institution" name="institute" value="{{ $teacher->bio->institute }}"
                            class="form-input" placeholder="Ex: Universidade Rovuma" required>
